...
const MusicLibrary = ({ role }) => {
  ...
  return (
    <div className="items-center min-height-screen max-w-[80vw] justify-center bg-black text-white">
    <div className="bg-neutral-900 max-w-[80vw] rounded-2xl shadow-2xl p-10 w-full max-w-md border border-green-500">
